...
Value getnewaddress(const Array& params, bool fHelp)
{
    ...
    if (params.size() > 0)
    {
        ...
        {
            throw JSONRPCError(RPC_NOT_SUPPORTED, "Accounts are not supported with scalable wallet - if you need accounts, run rightpeerd -walletdbversion=1 -rescan, but the wallet will perform worse");        
        }            
...
Value listaddresses(const Array& params, bool fHelp)
{
    ...
    {
        throw JSONRPCError(RPC_NOT_SUPPORTED, "API is not supported with this wallet version. To get this functionality, run \"rightpeerd -walletdbversion=2 -rescan\" ");        
    }   
...
Value getreceivedbyaddress(const Array& params, bool fHelp)
{
    ...
    if(mc_gState->m_WalletMode & MC_WMD_ADDRESS_TXS)
    {
        throw JSONRPCError(RPC_NOT_SUPPORTED, "Not supported with scalable wallet - if you need accounts, run rightpeerd -walletdbversion=1 -rescan, but the wallet will perform worse");        
    }            
...
Value getbalance(const Array& params, bool fHelp)
{
    ...
    if(mc_gState->m_WalletMode & MC_WMD_ADDRESS_TXS)
    {
        throw JSONRPCError(RPC_NOT_SUPPORTED, "Accounts are not supported with scalable wallet - if you need getbalance, run rightpeerd -walletdbversion=1 -rescan, but the wallet will perform worse");        
    }
    string strAccount = AccountFromValue(params[0]);
...
Value movecmd(const Array& params, bool fHelp)
{
    ...
    if(mc_gState->m_WalletMode & MC_WMD_ADDRESS_TXS)
    {
        throw JSONRPCError(RPC_NOT_SUPPORTED, "Accounts are not supported with scalable wallet - if you need move, run rightpeerd -walletdbversion=1 -rescan, but the wallet will perform worse");        
    }
...
Value sendfrom(const Array& params, bool fHelp)
{
    ...
    if(mc_gState->m_WalletMode & MC_WMD_ADDRESS_TXS)
    {
        throw JSONRPCError(RPC_NOT_SUPPORTED, "Accounts are not supported with scalable wallet - if you need sendfrom, run rightpeerd -walletdbversion=1 -rescan, but the wallet will perform worse");        
    }
...
Value sendmany(const Array& params, bool fHelp)
{
    ...
    if(mc_gState->m_WalletMode & MC_WMD_ADDRESS_TXS)
    {
        throw JSONRPCError(RPC_NOT_SUPPORTED, "Accounts are not supported with scalable wallet - if you need sendmany, run rightpeerd -walletdbversion=1 -rescan, but the wallet will perform worse");        
    }
...
Value listtransactions(const Array& params, bool fHelp)
{
    ...
    if(mc_gState->m_WalletMode & MC_WMD_ADDRESS_TXS)
    {
        throw JSONRPCError(RPC_NOT_SUPPORTED, "Not supported with scalable wallet - if you need listtransactions, run rightpeerd -walletdbversion=1 -rescan, but the wallet will perform worse");        
    }
    else
    {
...
Value listaccounts(const Array& params, bool fHelp)
{
    ...
    if(mc_gState->m_WalletMode & MC_WMD_ADDRESS_TXS)
    {
        throw JSONRPCError(RPC_NOT_SUPPORTED, "Accounts are not supported with scalable wallet - if you need listaccounts, run rightpeerd -walletdbversion=1 -rescan, but the wallet will perform worse");        
    }   
