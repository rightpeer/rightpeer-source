...
//    obj.push_back(Pair("protocolversion", PROTOCOL_VERSION));
    ...
    obj.push_back(Pair("nodeaddress", RightpeerServerAddress(true) + strprintf(":%d",GetListenPort())));       
...
Value setruntimeparam(const json_spirit::Array& params, bool fHelp)
{
    ...
    {
        throw JSONRPCError(RPC_NOT_SUPPORTED, "This API is supported only if protocol=rightpeer");                
    }
