...
/* MCHN END */    
    ...
    strUsage += "  -hideknownopdrops=<n>                    " + strprintf(_("Remove recognized RightPeer OP_DROP metadata from the responses to JSON_RPC calls (default: %u)"), 0) + "\n";
