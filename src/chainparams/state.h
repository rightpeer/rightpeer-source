...
#ifndef RIGHTPEER_STATE_H
#define	RIGHTPEER_STATE_H

#include "utils/define.h"
#include "chainparams/params.h"
#include "protocol/rightpeerscript.h"
...
{    
    const mc_OneRightpeerParam *m_Param;
    int64_t m_Value;    
    uint32_t m_Block;
    int32_t m_Skipped; 
...
{    
    ...
    mc_Params               *m_Params;
    mc_RightpeerParams     *m_NetworkParams;
    ...
    void  InitDefaults()
    {
        ...
        m_NetworkParams=new mc_RightpeerParams;
        m_Permissions=NULL;
        m_Assets=NULL;
