...
#ifndef RIGHTPEERPARAMLIST_H
#define RIGHTPEERPARAMLIST_H

static const mc_OneRightpeerParam RightpeerParamArray[] =
{
    { "chainprotocol"                          , "chain-protocol"                          ,
                   ...
                   "Chain protocol: rightpeer (permissions, native assets) or bitcoin"},
...
*/                   
    ...
    { "chainname"                              , "chain-name"                              ,
                   ...
                   "protocolversion","",
                   "Chain name, used as first argument for rightpeerd and rightpeer-cli."},                   
