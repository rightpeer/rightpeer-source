...
bool AppInit(int argc, char* argv[])
{
    ...
    {
        fprintf(stderr,"\nError: Data directory %s needs to exist before calling rightpeerd-cold. Exiting...\n\n",mapArgs["-datadir"].c_str());
        return false;        
    }
        
    if(!mc_DoesParentLogDirExist())
    {
        fprintf(stderr,"\nError: Log directory %s needs to exist before calling rightpeerd-cold. Exiting...\n\n",mapArgs["-logdir"].c_str());
        return false;        
    }
        ...
        (mc_gState->m_Params->NetworkName() == NULL))
    {
        ...
        {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  rightpeerd-cold <blockchain-name> [options]                     " + _("Start RightPeer Offline Daemon") + "\n";
