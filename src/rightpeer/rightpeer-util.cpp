...
int main(int argc, char* argv[])
{
    ...
    mc_RightpeerParams* params;
    mc_RightpeerParams* paramsOld;
...
//                    err=params->Create(mc_gState->m_Params->m_Arguments[1],version);
                ...
                { 
                    ...
                    printf("You can edit it in %s before running rightpeerd for the first time.\n\n",fileName);
                    printf("To generate blockchain please run \"rightpeerd %s -daemon\".\n",params->Name());
                }                
                else
                {
        ...
        if(strcmp(mc_gState->m_Params->Command(),"clone") == 0)
        {
            ...
            {
                params=new mc_RightpeerParams;
                paramsOld=new mc_RightpeerParams;
...
*/        
    ...
    if(err == MC_ERR_OPERATION_NOT_SUPPORTED)
    {
        ...
        printf("Usage:\n");
        printf("  rightpeer-util create <blockchain-name>  ( <protocol-version> = %d ) [options]        Creates new rightpeer configuration file %s with default parameters\n",
        ...
        printf("  rightpeer-util clone <old-blockchain-name> <new-blockchain-name> [options]               Creates new rightpeer configuration file %s copying parameters\n",fileName);
